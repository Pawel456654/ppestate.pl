export default function AboutExtendedContent() {
  return (
    <section className="border-t border-neutral-200/80 bg-white py-12 md:py-16 px-6 sm:px-8 lg:px-12">
      <div className="mx-auto max-w-[58rem] text-left text-neutral-950">
        <div className="space-y-12 md:space-y-14">
          ...
          <div>
            ...
            <div className="space-y-4 text-base leading-[1.62] md:text-lg md:leading-relaxed">
              ...
              <ul className="list-disc space-y-1.5 pl-6 marker:text-neutral-950">
                <li>
                  <strong>transparentność</strong> i rzetelne informacje,
                </li>
